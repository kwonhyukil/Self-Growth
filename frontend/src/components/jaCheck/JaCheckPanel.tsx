...
import { useJaLatest, useRunJaCheck } from '../../hooks/useJaCheck'
import { ScoreBadge, ScoreBar } from './ScoreBadge'
import { IssueCard } from './IssueCard'
import { Button } from '../ui/Button'
import { ErrorMessage } from '../ui/ErrorMessage'
import { Spinner } from '../ui/Spinner'
import { RewritePanel } from '../revision/RewritePanel'
    ...
    <div className="space-y-6">
      ...
      {!feedback && (
        <div className="text-center space-y-3 py-4">
          ...
          <p className="text-xs text-slate-400">※ 1分あたり最大10回まで</p>
        </div>
      )}
        ...
        <div className="space-y-5 animate-slide-up">
          ...
          <div className="rounded-2xl border border-slate-200 bg-white p-5">
            ...
            <div className="mt-4 rounded-lg bg-brand-50 border border-brand-100 px-4 py-3">
              <p className="text-xs font-semibold text-brand-700 mb-1">コーチからの質問</p>
          ...
          {feedback.issues.length > 0 ? (
            ...
            <div className="rounded-xl bg-emerald-50 border border-emerald-200 px-4 py-4 text-center">
              <p className="text-emerald-700 font-medium">🎉 問題は見つかりませんでした！</p>
            </div>
          )}
