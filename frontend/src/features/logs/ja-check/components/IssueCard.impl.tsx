...
import { RULE_TAG_LABEL, SEVERITY_COLOR, SEVERITY_LABEL } from '@/shared/lib/constants'
      ...
      >
        ...
        <div className="flex-1 min-w-0">
          <div className="flex flex-wrap items-center gap-2 mb-1">
            ...
            <Badge variant="outline" className="bg-surface-elevated/60 text-text-sub border-border">
